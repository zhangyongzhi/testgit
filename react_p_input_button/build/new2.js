...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TestClickComponent = function (_Component) {
	    _inherits(TestClickComponent, _Component);

	    function TestClickComponent(props) {
	        _classCallCheck(this, TestClickComponent);

	        return _possibleConstructorReturn(this, (TestClickComponent.__proto__ || Object.getPrototypeOf(TestClickComponent)).call(this));
	    }

	    _createClass(TestClickComponent, [{
	        key: 'handleClick',
	        value: function handleClick(event) {

	            var tipE = _reactDom2['default'].findDOMNode(this.refs.tip);
	    ...
	    return TestClickComponent;
	}(_react.Component);

	var TestInputComonent = function (_Component2) {
	    _inherits(TestInputComonent, _Component2);

	    function TestInputComonent(props) {
	        _classCallCheck(this, TestInputComonent);

	        var _this2 = _possibleConstructorReturn(this, (TestInputComonent.__proto__ || Object.getPrototypeOf(TestInputComonent)).call(this));
	    ...
	    _createClass(TestInputComonent, [{
	        key: 'changeHandler',
	    ...
	    return TestInputComonent;
	}(_react.Component);

	_reactDom2['default'].render(_react2['default'].createElement(
	    'div',
	    null,
	    _react2['default'].createElement(TestInputComonent, null),
	    _react2['default'].createElement(TestClickComponent, null)
